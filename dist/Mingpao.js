...
var Mingpao = (function (_BaseScraper) {
  ...
  _createClass(Mingpao, [{
    ...
    value: function list(done) {
      var results = null;
      this.nightmare().goto("http://news.mingpao.com/pns/%E6%96%B0%E8%81%9E%E7%B8%BD%E8%A6%BD/web_tc/archive/latest").wait(function () {
        return typeof jQuery !== 'undefined';
      }, true).evaluate(function () {
        var links = [];
        $('.listing ul li a').each(function (idx, a) {
